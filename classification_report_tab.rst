...
.. figure:: _static/interface/classification_report_tab.png
    :align: center
    :width: 100%
...
This tab allows for the calculation of class statistics such as number of
pixels, percentage and area (area unit is defined from the image itself).

.. tip::
    Information about APIs of this tool in Remotior Sensus at this
    `link <https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.raster_report.html>`_ .

.. _classification_report_input:
