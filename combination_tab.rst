...
.. figure:: _static/interface/combination_tab.png
    :align: center
    :width: 100%

    :guilabel:`Combination`
...
.. tip::
    ...
    `link <https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.band_combination.html>`_ .
