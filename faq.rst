...
Following an incomplete list of these resources (please note that these resources could use older versions of SCP):
	...
	* `Polish: Klasyfikacja pokrycia terenu w QGIS SCP <http://nycz.beskidy.pl/2018/01/29/klasyfikacja-pokrycia-terenu-w-qgis-scp-cz-2/>`_;
	* `Polish: Klasyfikacja nienadzorowana w QGIS SCP <http://nycz.beskidy.pl/2018/02/04/klasyfikacja-nienadzorowana-qgis-scp/>`_;
