...
.. figure:: _static/settings_interface_tab.png
	:align: center
	:width: 500pt
...
* :guilabel:`MC Name field` |input_text| |registry_save|: name of the Macroclass Name field (default is ``MC_info``);
* :guilabel:`C ID field` |input_text| |registry_save|: name of the Class ID field (default is ``C_ID``);
* :guilabel:`C Name field` |input_text| |registry_save|: name of the Class Name field (default is ``C_info``);
...
* |checkbox| :guilabel:`Create RGB composite of band set when a project is loaded` |registry_save|: if checked, a RGB composite of active band set is added to the map when a project is loaded;
...
* |checkbox| :guilabel:`Download news on startup` |registry_save|: if checked, news about the :guilabel:`SCP` and related services are downloaded on startup and displayed in :guilabel:`Dock`;