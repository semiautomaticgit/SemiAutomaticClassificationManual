...
.. figure:: _static/interface/pca_tab.png
    :align: center
    :width: 100%
...
.. tip::
    ...
    `link <https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.band_pca.html>`_ .
...
.. list-table::
    ...
    * - |checkbox| :guilabel:`Number of components` |input_number| |optional|
      - set the number of components to be calculated
...
The ``Output`` tab will display the Principal Components Analysis details
(Covariance matrix, Correlation matrix, Eigenvectors, and Eigenvalues).
