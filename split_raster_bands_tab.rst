...
.. |split_raster| image:: _static/semiautomaticclassificationplugin_reproject_tool.png
    :width: 18pt


.. figure:: _static/interface/split_raster_bands_tab.png
    :align: center
    :width: 100%
...
.. tip::
    ...
    `link <https://remotior-sensus.readthedocs.io/en/latest/remotior_sensus.tools.raster_split.html>`_ .
...
.. list-table::
    ...
    * - Tool symbol and name
      - Description
    * - :guilabel:`Select a multiband raster` |input_list|
      - select the input raster
    * - |reload|
      - refresh layer list
    * - :guilabel:`Output name prefix` |input_text|
      - set the prefix for output file names (default is ``split``)
